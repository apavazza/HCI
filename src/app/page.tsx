...
const Page = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-10">
      <div className="flex flex-col justify-center m-3 bg-green-200 w-11/12 rounded-lg border border-gray-200 shadow-md">
        <span className="mx-auto p-3">Unlock Your Voice With Professional Blogging Services</span>
        <span className="mx-auto block w-44 m-2 p-3 border bg-black text-white text-center hover:bg-green-800 active:bg-green-700">TRY IT FOR FREE</span>
      </div>
